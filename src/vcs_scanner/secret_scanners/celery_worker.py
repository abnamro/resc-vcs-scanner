...
# First Party
from vcs_scanner.common import initialise_logs, load_vcs_instances, _tag_list_addition
...
def scan_repository(repository):
    ...
    try:
        ...
        include_tags = _tag_list_addition(include_tags, vcs_instance.include_tags)
        ...
        ignore_tags = _tag_list_addition(ignore_tags, vcs_instance.ignore_tags)
