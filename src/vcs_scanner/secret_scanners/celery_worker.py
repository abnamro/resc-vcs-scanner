...
def scan_repository(repository):
    ...
    try:
        ...
        include_tags = list(set(include_tags) | set(vcs_instance.include_tags)) if include_tags else None
        ...
        ignore_tags = list(set(ignore_tags) | set(vcs_instance.ignore_tags)) if ignore_tags else None
